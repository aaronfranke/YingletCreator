...
public class ExportToModelOnButtonClick : ExportOnButtonClickBase
{
	...
	[SerializeField] private ExportModelFormat _exportFormat = ExportModelFormat.NONE;
	...
	private void Update()
	{
		...
		{
			case ExportModelFormat.G3MF:
				binaryExtension = ".g3b";
				textExtension = ".g3tf";
				break;
			case ExportModelFormat.GLTF:
				binaryExtension = ".glb";
				textExtension = ".gltf";
				break;
			case ExportModelFormat.VRM_0_x:
			case ExportModelFormat.VRM_1_0:
				binaryExtension = ".vrm";
				textExtension = ".gltf";
				break;
			default:
